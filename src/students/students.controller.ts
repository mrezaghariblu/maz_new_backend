...
export class StudentsController {
  ...
  setAssistiveDevices(
    @Param('id') id: string,
    @Body() dto: SetAssistiveDevicesDto,
  ) {
  ...
  @Roles(UserType.SUPERUSER, UserType.CENTER_MANAGER)
  @UseInterceptors(AuditInterceptor)
  @AuditEntity('StudentClassAssignment')
  @AuditAction('CREATE')
  assignToClass(
    @Param('id') id: string,
    @Body() dto: AssignToClassDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  @Roles(UserType.SUPERUSER, UserType.CENTER_MANAGER)
  @UseInterceptors(AuditInterceptor)
  @AuditEntity('StudentPromotionDecision')
  @AuditAction('CREATE')
  recordPromotion(
    @Param('id') id: string,
    @Body() dto: PromotionDecisionDto,
    @CurrentUser() user: JwtPayload,
  ) {
  ...
  getUnassignedCount(
    ...
    return this.svc
      .getUnassignedCount(+centerId, +academicYearId)
      .then((count) => ({ count }));
  }
}
